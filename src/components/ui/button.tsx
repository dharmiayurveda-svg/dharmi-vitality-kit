  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        whatsapp:
          "bg-whatsapp text-whatsapp-foreground shadow-lg hover:bg-whatsapp/90 hover:shadow-xl hover:scale-105",
        gold:
          "gradient-gold text-gold-foreground shadow-gold hover:opacity-90 hover:scale-105 font-semibold",
        cta:
          "gradient-green text-primary-foreground shadow-nature hover:opacity-90 hover:scale-105 font-bold tracking-wide",
      },
      size: {
